...
$page_title = "Home Energy and Appliance Calculators - Electricity Cost Estimator";
$meta_description = "Accurate home energy and appliance electricity cost calculators. Calculate appliance kWh, monthly utility bills, and Energy Star savings with 2026 tariff benchmarks.";
$focus_keyword = "home energy and appliance calculators";
$canonical_path = "";

$home_schema = [
    '@type' => 'WebSite',
    'name' => 'VoltMetrics Home Energy Intelligence',
    'potentialAction' => [
        '@type' => 'SearchAction',
        'target' => SITE_URL . '/calculators/appliance-electricity-cost.php?q={search_term_string}',
...
<html lang="en">
<head>
    <?php render_seo_head($page_title, $meta_description, $focus_keyword, $canonical_path, 'WebSite', $home_schema); ?>
</head>
<body>
    ...
    <div class="container hero-grid">
        <div class="hero-text-col">
            ...
            <div style="display: flex; gap: 14px; flex-wrap: wrap;">
                <a href="/all-calculators.php" class="btn btn-primary">
                    Explore All 15 Calculators
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg>
                </a>
                <a href="/calculators/appliance-electricity-cost.php" class="btn btn-outline">
        ...
        <div class="hero-image-col">
            <div class="hero-img-wrap">
                <img src="/assets/images/smart_energy_home.jpg" 
        ...
        <div class="calculator-wrapper" style="box-shadow: var(--shadow-lg);">
            ...
            <div class="calc-presets-section">
                <div class="presets-header">
                    ...
                    <a href="/calculators/appliance-electricity-cost.php" style="font-size: 0.8125rem; font-weight: 700; color: var(--emerald-600);">
            ...
            <div class="calc-grid">
                ...
                <div class="calc-inputs-col">
                    ...
                    <div class="calc-group">
                        ...
                        <input type="range" id="calcHoursRange" class="calc-range" min="0.5" max="24" step="0.5" value="24" aria-label="Hours slider">
                    </div>
                    ...
                    <div class="calc-group">
                        ...
                        <input type="range" id="calcDutyRange" class="calc-range" min="5" max="100" step="5" value="35" aria-label="Duty cycle slider">
                    </div>
...
<section class="section-padding" id="categories">
    <div class="container">
        ...
        <div class="categories-grid">
            ...
            <div class="cat-card active-category">
                ...
                <div style="display: flex; gap: 8px; margin-top: auto;">
                    <a href="/calculators/appliance-electricity-cost.php" class="btn btn-primary btn-sm" style="flex: 1; text-align: center;">
                        Open Calculator
                    </a>
                    <a href="/categories/appliances.php" class="btn btn-outline btn-sm" title="View all 3 appliance tools">
                        All 3 Tools &rarr;
                    </a>
                </div>
            </div>
            ...
            <div class="cat-card active-category">
                ...
                <div style="display: flex; gap: 8px; margin-top: auto;">
                    <a href="/calculators/air-conditioner-running-cost.php" class="btn btn-primary btn-sm" style="flex: 1; text-align: center;">
                        Open Calculator
                    </a>
                    <a href="/categories/hvac-cooling-heating.php" class="btn btn-outline btn-sm" title="View all 5 HVAC tools">
                        All 5 Tools &rarr;
                    </a>
                </div>
            </div>
            ...
            <div class="cat-card active-category">
                ...
                <div style="display: flex; gap: 8px; margin-top: auto;">
                    <a href="/calculators/generator-runtime.php" class="btn btn-primary btn-sm" style="flex: 1; text-align: center;">
                        Open Calculator
                    </a>
                    <a href="/categories/backup-power.php" class="btn btn-outline btn-sm" title="View all 4 backup tools">
                        All 4 Tools &rarr;
                    </a>
                </div>
            </div>
            ...
            <div class="cat-card active-category">
                ...
                <div style="display: flex; gap: 8px; margin-top: auto;">
                    <a href="/calculators/ev-home-charging-cost.php" class="btn btn-primary btn-sm" style="flex: 1; text-align: center;">
                        Open Calculator
                    </a>
                    <a href="/categories/ev-utility.php" class="btn btn-outline btn-sm" title="View all 3 EV and utility tools">
                        All 3 Tools &rarr;
                    </a>
                </div>
        </div>
        ...
        <div style="text-align: center; margin-top: 36px;">
            <a href="/all-calculators.php" class="btn btn-primary" style="font-size: 1rem; padding: 14px 28px; box-shadow: var(--shadow-md);">
