<?php
/**
 * Template Name: Appliance Calculator
 *
 * This template renders the Appliance Electricity Cost Calculator.
 */

get_header();

// Make sure appliance presets are loaded from config/rates.php
...
<main class="calc-page">
    <div class="container">
        ...
        <nav class="breadcrumbs" aria-label="breadcrumb">
            ...
            <a href="<?php echo esc_url(home_url('/all-calculators/')); ?>">All Calculators</a>
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="9 18 15 12 9 6"></polyline></svg>
            <a href="<?php echo esc_url(home_url('/categories/appliances/')); ?>">Appliances</a>
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="9 18 15 12 9 6"></polyline></svg>
            <span aria-current="page">Appliance Cost Tool</span>
        </nav>

        <!-- Calculator Header -->
        <div class="calc-header-box">
            <div class="calc-badge">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"></rect><circle cx="12" cy="14" r="4"></circle><line x1="12" y1="6" x2="12.01" y2="6"></line></svg>
            ...
            <div class="calc-grid">
                ...
                <div class="calc-inputs-col">
                    ...
                    <div class="calc-group">
                        ...
                        <input type="range" id="calcHoursRange" class="calc-range" min="0" max="24" step="0.5" value="24" aria-label="Hours per day slider">
                    ...
                    <div class="calc-group">
                        ...
                        <input type="range" id="calcDutyRange" class="calc-range" min="0" max="100" step="5" value="35" aria-label="Duty cycle percentage slider">
