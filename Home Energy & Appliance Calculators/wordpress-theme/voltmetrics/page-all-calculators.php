...
// We need the catalog array, which we can define here or load via functions.
// For the sake of the template, we'll embed the array here as it was in the original file.
$calculators_catalog = [
    // Category 1
    [
        ...
        'url' => home_url('/appliance-electricity-cost/'),
        'is_popular' => true,
    ...
    [
        ...
        'url' => home_url('/watts-to-monthly-cost/'),
        'is_popular' => false,
        'tag' => 'Continuous Load',
    ...
    [
        ...
        'url' => home_url('/refrigerator-energy-cost/'),
        'is_popular' => false,
        'tag' => 'Kitchen Cooling',
    ...
    [
        ...
        'url' => home_url('/air-conditioner-running-cost/'),
        'is_popular' => true,
    ...
    [
        ...
        'url' => home_url('/mini-split-electricity-cost/'),
        'is_popular' => false,
    ...
    [
        ...
        'url' => home_url('/space-heater-cost/'),
        'is_popular' => false,
        'tag' => 'Winter Heating',
    ...
    [
        ...
        'url' => home_url('/heat-pump-savings/'),
        'is_popular' => false,
        'tag' => 'Decarbonization',
    ...
    [
        ...
        'url' => home_url('/ceiling-fan-electricity/'),
        'is_popular' => false,
    ...
    [
        ...
        'url' => home_url('/generator-runtime/'),
        'is_popular' => true,
        'tag' => 'Category Popular Pick',
    ...
    [
        ...
        'url' => home_url('/generator-fuel-cost/'),
        'is_popular' => false,
    ...
    [
        ...
        'url' => home_url('/solar-battery-runtime/'),
        'is_popular' => false,
    ...
    [
        ...
        'url' => home_url('/portable-power-station-runtime/'),
        'is_popular' => false,
    ...
    [
        ...
        'url' => home_url('/ev-home-charging-cost/'),
        'is_popular' => true,
        'tag' => 'Category Popular Pick',
    ...
    [
        ...
        'url' => home_url('/pool-pump-electricity/'),
        'is_popular' => false,
    ...
    [
        ...
        'url' => home_url('/electricity-bill-increase/'),
        'is_popular' => false,
        ...
        <div id="dirGrid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(340px, 1fr)); gap: 24px;">
            <?php foreach ($calculators_catalog as $tool): ?>
                <div class="calc-directory-card" 
                     data-cat="<?php echo esc_attr($tool['category_id']); ?>" 
                     data-keywords="<?php echo esc_attr(strtolower($tool['name'] . ' ' . $tool['sub_category'] . ' ' . $tool['desc'])); ?>">
                    <div class="calc-dir-top">
                        <span class="calc-subcat-badge"><?php echo esc_html($tool['sub_category']); ?></span>
                        <?php if ($tool['is_popular']): ?>
                            <span class="calc-popular-badge"><?php echo esc_html($tool['tag']); ?></span>
                        <?php else: ?>
                            <span style="font-size: 0.75rem; color: var(--slate-400); font-weight: 600;"><?php echo esc_html($tool['tag']); ?></span>
                        <?php endif; ?>
                    </div>

                    <h2 class="calc-dir-title">
                        <a href="<?php echo esc_url($tool['url']); ?>" style="color: var(--slate-900); text-decoration: none;">
                    ...
                    <div style="margin-top: auto; padding-top: 14px; border-top: 1px solid var(--slate-100);">
                        <a href="<?php echo esc_url($tool['url']); ?>" class="btn btn-primary btn-sm" style="width: 100%; text-align: center;">
