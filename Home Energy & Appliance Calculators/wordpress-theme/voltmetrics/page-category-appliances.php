<?php
/**
 * Template Name: Category - appliances
 */
    ...
    <div class="container">
        ...
        <div style="background: var(--white); border: 1px solid var(--border-subtle); border-radius: var(--radius-xl); padding: 36px; margin-bottom: 40px; box-shadow: var(--shadow-sm);">
            <div style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 30px; align-items: center;">
                <div>
                    ...
                    <a href="<?php echo esc_url(home_url('/')); ?>appliance-electricity-cost/" class="btn btn-primary">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(320px, 1fr)); gap: 24px;">
            ...
            <div class="cat-card active-category">
                ...
                <div style="margin-top: auto; padding-top: 16px;">
                    <a href="<?php echo esc_url(home_url('/')); ?>watts-to-monthly-cost/" class="btn btn-primary" style="width: 100%;">
            ...
            <div class="cat-card active-category">
                ...
                <div style="margin-top: auto; padding-top: 16px;">
                    <a href="<?php echo esc_url(home_url('/')); ?>refrigerator-energy-cost/" class="btn btn-primary" style="width: 100%;">
                        Open Calculator (Active)
                    </a>
                </div>
            </div>
