<?php
/**
 * Template Name: Category - ev-utility
 */
            ...
            <div style="display: grid; grid-template-columns: 1.2fr 0.8fr; gap: 30px; align-items: center;">
                <div>
                    ...
                    <div style="display: flex; gap: 12px; flex-wrap: wrap;">
                        <a href="<?php echo esc_url(home_url('/')); ?>ev-home-charging-cost/" class="btn btn-primary">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(320px, 1fr)); gap: 24px;">
            ...
            <div class="cat-card active-category">
                ...
                <div style="margin-top: auto; padding-top: 16px;">
                    <a href="<?php echo esc_url(home_url('/')); ?>ev-home-charging-cost/" class="btn btn-primary" style="width: 100%;">
            ...
            <div class="cat-card active-category">
                ...
                <div style="margin-top: auto; padding-top: 16px;">
                    <a href="<?php echo esc_url(home_url('/')); ?>pool-pump-electricity/" class="btn btn-primary" style="width: 100%;">
                        Open Calculator (Active)
                    </a>
                </div>
            </div>
            ...
            <div class="cat-card active-category">
                ...
                <div style="margin-top: auto; padding-top: 16px;">
                    <a href="<?php echo esc_url(home_url('/')); ?>electricity-bill-increase/" class="btn btn-primary" style="width: 100%;">
                        Open Calculator (Active)
                    </a>
                </div>
            </div>
